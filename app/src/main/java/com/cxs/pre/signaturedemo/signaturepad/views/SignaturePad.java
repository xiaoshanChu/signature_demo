package com.cxs.pre.signaturedemo.signaturepad.views;
...
import com.cxs.pre.signaturedemo.R;
import com.cxs.pre.signaturedemo.signaturepad.utils.Bezier;
import com.cxs.pre.signaturedemo.signaturepad.utils.ControlTimedPoints;
import com.cxs.pre.signaturedemo.signaturepad.utils.TimedPoint;
...
public class SignaturePad extends View {
    ...
    public SignaturePad(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mMaxWidth = a.getDimensionPixelSize(R.styleable.SignaturePad_maxWidth, convertDpToPx(5));
    ...
    public void setPenColorRes(int colorRes) {
        try {
            ...
            setPenColor(getResources().getColor(R.color.colorBlack));
        }
    }
